...
import profile from "../assets/Siddhi_Profile.png"
...
const Hero=()=>{
    ...
    <div className="flex flex-wrap">
       ...
       initial="hidden"
       animate="visible" 
       className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-7xl">Siddhi Ove</motion.h1>
        <motion.span  
  ...
  className="bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-4xl tracking-tight text-transparent">Full Stack Developer</motion.span>
       ...
       {HERO_CONTENT}
        ...
        <div className="w-full h-30 lg:w-1/2 lg:p-7">
